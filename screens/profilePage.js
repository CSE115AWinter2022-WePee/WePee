      ...
      default: // default is a user review
        return (
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('Details', { bathroomId: item.bathroom_id, bathroomName: item.name, uid: route.params?.uid, region: route.params?.region, mapType: route.params?.mapType })}
          >
